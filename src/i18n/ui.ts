...
export const labels = {
  es: {
    ...
    "aboutUs.bento.first.imageAlt":
      "Dos ingenieros o capataces con cascos de seguridad y chalecos reflectantes, revisando planos en una obra de construcción con un edificio en proceso al fondo.",
    "aboutUs.bento.second.imageAlt":
      "Dos trabajadores de la construcción con cascos y arneses de seguridad, operando en una estructura de acero y encofrado en una obra.",
...
"reviews.description.third":
  "Será un gusto acompañarlos y construir juntos.",
    ...
    "footer.blog.second.title":
      "Qué tan importante es el diseñoestructural en proyectos comericales",
    "footer.blog.third.title":
      "Los desafios de la construcción industrial especializada",
